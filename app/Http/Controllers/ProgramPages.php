...
class ProgramPages extends Controller
{
    public function programItemSave(AddComxRequest $request)
    {
        ...
        $product->comx_img_1 = $request->file('comx_img_1')->store('app/admin', 'public');
        $product->comx_img_2 = $request->file('comx_img_2')->store('app/admin', 'public');
        $product->comx_img_3 = $request->file('comx_img_3')->store('app/admin', 'public');
        $product->comx_img_4 = $request->file('comx_img_4')->store('app/admin', 'public');
        $product->comx_img_5 = $request->file('comx_img_5')->store('app/admin', 'public');
