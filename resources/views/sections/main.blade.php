...
@section('header')
    <header class="main_header p-5 text-center bg-image"
        ...
        <div class="w-100 buttons_nav row mb-3 text-center">
            ...
            <a href="#" class="col m-3">
                <button class="w-100">НОВИНКИ</button>
            </a>
            <a href="#" class="col m-3">
                <button class="w-100">БЕСТСЕЛЛЕРЫ</button>
            </a>
            <a href="#" class="col m-3">
                <button class="w-100">АКЦИИ</button>
            </a>
            <a href="#" class="col m-3">
                <button class="w-100">ПОДАРКИ И УКРАШЕНИЯ</button>
            </a>
        </div>
    </header>
@endSection
...
@section('content')
    <div class="pattern_div background__pattern_image">
